...
ENDM
	...
	mapconst VIRIDIAN_CITY,                 18, 22 ; $01
	mapconst PEWTER_CITY,                   18, 20 ; $02
	mapconst CERULEAN_CITY,                 18, 20 ; $03
	mapconst LAVENDER_TOWN,                  9, 17 ; $04
	mapconst VERMILION_CITY,                18, 20 ; $05
	mapconst CELADON_CITY,                  18, 25 ; $06
	mapconst FUCHSIA_CITY,                  18, 22 ; $07
	mapconst CINNABAR_ISLAND,               10, 12 ; $08
	mapconst INDIGO_PLATEAU,                10, 14 ; $09
	...
	mapconst ROUTE_5,                       19, 11 ; $10
	mapconst ROUTE_6,                       18, 11 ; $11
	mapconst ROUTE_7,                       12, 15 ; $12
	mapconst ROUTE_8,                        9, 30 ; $13
	mapconst ROUTE_9,                        9, 30 ; $14
	mapconst ROUTE_10,                      36, 10 ; $15
	mapconst ROUTE_11,                      13, 30 ; $16
	...
	mapconst Y1,                  		 7, 20 ; 
	mapconst X1,                  		 5, 15 ; 
	mapconst UNUSED_MAP_0B,                  0,  0 ; $0B ; MAP ADDRESS APPEARS BROKEN, DO NOT USE?
	mapconst X2,                  		 6, 15 ; 
	mapconst Y2,                  		 8, 45 ; 
	mapconst X3,                  		10, 15 ; 
	mapconst X4,                  		 8,  8 ; 
	...
	mapconst DIGLETTS_CAVE_ROUTE_2,          4,  9 ; $2E
	...
	mapconst VIRIDIAN_FOREST,               24, 17 ; $33 ; $40, ACTUALLY
	...
	mapconst CERULEAN_MART,                  4,  4 ; $43 ; $50, ACTUALLY
	...
	mapconst ROCK_TUNNEL_1F,                18, 20 ; $52 ; $5F
	mapconst POWER_PLANT,                   18, 20 ; $53 ; $60, ACTUALLY
	...
	mapconst SS_ANNE_BOW,                    7, 10 ; $63 ; $70, ACTUALLY
	...
	mapconst CELADON_MART_2F,                4, 10 ; $7B ; $80, ACTUALLY
	...
	mapconst CELADON_CHIEF_HOUSE,            4,  4 ; $8B ; $90, ACTUALLY
	...
	mapconst WARDENS_HOUSE,                  4,  5 ; $9B ; $A0, ACTUALLY
	mapconst SAFARI_ZONE_GATE,               3,  4 ; $9C ; $A1
	mapconst FUCHSIA_GYM,                    9,  9 ; $9D ; $A2
	mapconst FUCHSIA_MEETING_ROOM,           4,  7 ; $9E ; $A3
	mapconst SEAFOAM_ISLANDS_B1F,            9, 15 ; $9F ; $A4
	mapconst SEAFOAM_ISLANDS_B2F,            9, 15 ; $A0 ; $A5
	mapconst SEAFOAM_ISLANDS_B3F,            9, 15 ; $A1 ; $A6
	mapconst SEAFOAM_ISLANDS_B4F,            9, 15 ; $A2 ; $A7
	...
	mapconst CINNABAR_POKECENTER,            4,  7 ; $AB ; $B0, ACTUALLY 
	...
	mapconst ROUTE_16_GATE_2F,               4,  4 ; $BB ; $C0, ACTUALLY
	...
	mapconst DIGLETTS_CAVE,                 31, 31 ; $C5 ; $CA
	...
	mapconst SAFARI_ZONE_WEST,              13, 15 ; $DB ; $E0, ACTUALLY

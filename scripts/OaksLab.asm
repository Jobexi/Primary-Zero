...
.asm_1d2ed
	jp TextScriptEnd
.doGiveItem	
	ld hl, OaksLabSuccessText1
	call PrintText
	lb bc, POKE_BAIT, 1
	call GiveItem
	ld hl, OaksLabGetPrize
	call PrintText
	ld hl, OaksLabSuccessText2
	call PrintText
	ld a, $2
	ld [wStory2], a
	jp TextScriptEnd			
...
OaksLabChallengeText:
	TX_FAR _OaksLabChallengeText
	db "@"
	
OaksLabSuccessText1:
	TX_FAR _OaksLabSuccessText1
	db "@"	
	
OaksLabGetPrize:
	TX_FAR _OaksLabGetPrize
	TX_SFX_KEY_ITEM
	db "@"		
	
OaksLabSuccessText2:
	TX_FAR _OaksLabSuccessText2
	db "@"		

...
_OaksLabChallengeText::
	...
	line "are in order for "
	cont "your huge success"
	cont "at Indigo Plateau!"
	
	para "I believe there is"
	line "a cave near"
	cont "Cerulean which "
	cont "contains several"
	cont "rare #MON"
	cont "which you may be"
	cont "interested to"
	cont "collect."
	
	para "Also, I just "
	line "received word "
	cont "from the Indigo"
	cont "Plateau."
...
_OaksLabSuccessText2::
	text "This will let"
	line "you catch any of"
	cont "the more common"
	cont "#MON you'll "
	cont "find in Kanto."

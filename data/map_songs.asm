MapSongBanks:
	...
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; PATH OF LOVE
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; CRIMSON BLUFFS
	db MUSIC_CITIES1, BANK(Music_Cities1) ; UNUSED_MAP_0B ; BROKEN
	db MUSIC_CITIES1, BANK(Music_Cities1) ; CITRUS ORCHARD
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; PATH OF LIGHT
	db MUSIC_CITIES2, BANK(Music_Cities2) ; SUNSHINE VALLEY
	db MUSIC_CELADON, BANK(Music_Celadon) ; VERDANT ACRES
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; PATH OF UNITY
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; ROYAL TERRACE
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; IMPERIAL VISTA
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; UPSPIRALING PATH
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; VIOLET FIELDS
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; ASCENSION TOWER
	db MUSIC_GYM, BANK(Music_Gym) ; UNUSED_MAP_ED

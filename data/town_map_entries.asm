ExternalMapEntries:
	...
	EMAP $7,$8,Y1Name ; PATH OF LOVE
	EMAP $8,$7,X1Name ; CRIMSON BLUFFS
	EMAP $2,$A,Route1Name ; BROKEN MAP ID, DO NOT USE
	EMAP $7,$7,X2Name ; CITRUS ORCHARD
	EMAP $5,$0,Y2Name ; PATH OF LIGHT
	EMAP $C,$3,X3Name ; SUNSHINE VALLEY
	EMAP $6,$0,X4Name ; VERDANT ACRES
	EMAP $7,$F,Y3Name ; PATH OF TRUTH
	EMAP $F,$A,X5Name ; ROYAL TERRACE
	EMAP $1,$C,X6Name ; IMPERIAL VISTA
	EMAP $B,$7,Y4Name ; UPSPIRALING PATH
	EMAP $2,$2,X7Name ; VIOLET FIELDS
	EMAP $9,$7,X8Name ; ASCENSION TOWER	

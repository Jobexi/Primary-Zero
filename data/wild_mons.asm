WildDataPointers:
	...
	dw ViridianCityMons   ; VIRIDIAN_CITY
	dw PewterCityMons 	  ; PEWTER_CITY
	dw CeruleanCityMons   ; CERULEAN_CITY
	dw LavenderTownMons   ; LAVENDER_TOWN
	dw VermilionCityMons  ; VERMILION_CITY
	dw CeladonCityMons 	  ; CELADON_CITY
	dw FuchsiaCityMons 	  ; FUCHSIA_CITY
	dw CinnabarIslandMons ; CINNABAR_ISLAND
	dw NoMons      		  ; INDIGO_PLATEAU
	dw SaffronCityMons    ; SAFFRON_CITY
	...
	dw NoMons	   ; PATH OF LOVE
	dw NoMons	   ; CRIMSON BLUFFS
	dw NoMons	   ; DUMMY MAP, DON'T USE
	dw NoMons	   ; CITRUS ORCHARD
	dw NoMons	   ; PATH OF LIGHT
	dw NoMons	   ; SUNSHINE VALLEY
	dw NoMons	   ; VERDANT ACRES
	dw NoMons	   ; PATH OF UNITY
	dw NoMons	   ; ROYAL TERRACE
	dw NoMons	   ; IMPERIAL VISTA
...
INCLUDE "data/wildPokemon/viridiancity.asm"
...
INCLUDE "data/wildPokemon/vermilioncity.asm"
INCLUDE "data/wildPokemon/lavendertown.asm"
INCLUDE "data/wildPokemon/celadoncity.asm"
INCLUDE "data/wildPokemon/saffroncity.asm"
INCLUDE "data/wildPokemon/fuchsiacity.asm"
INCLUDE "data/wildPokemon/cinnabarisland.asm"
